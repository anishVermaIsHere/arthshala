...
const PeriodButton = ({open}) => {
  return (
    <button 
    onClick={()=>open(true)}
    aria-label='open add-period-form'
    className="flex items-center py-[13px] px-[33px] text-base text-white bg-[#5364FF] cursor-pointer rounded-full">
      <span className="mr-2">
        <svg
          width="18"
          height="18"
